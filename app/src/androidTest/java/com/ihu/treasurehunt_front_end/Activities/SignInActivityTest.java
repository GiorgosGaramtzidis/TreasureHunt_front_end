...
public class SignInActivityTest {
    ...
    public void signInActivityTest() {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.txtLoginUserName), withText("\n"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.txtLoginPassword),
                        childAtPosition(
                                ...
                                5),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("Marko1212@"), closeSoftKeyboard());

        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.txtLoginPassword), withText("Marko1212@"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
